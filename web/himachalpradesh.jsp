    ...
    <main>
      <section class="hero">
        ...
        <div class="hero-content">
          <h1>Welcome to Himachal Pradesh Tour</h1>
          <p>The beautiful landscapes and adventerous activities....</p>
      ...
      <section id="hotels" class="destinations">
        ...
        <div class="destination-grid" style="font-family:serif;font-size:20px">
          <div class="destination-item">
            ...
            <p>
              Embark on a magical adventure through Travel's World, starting from Dharamshala 
              and journeying through Shimla, Manali, Kufri, Kasoli, Kullu, Rohtang Pass
              before returning to Dharamshala. It's a chance to have a variety of warm cuisines in Himachal Pradesh, and immerse yourself in the serene 
              charm of Himachal Pradesh.
            </p>
            <h3><b><u>Quick Info:</b></u></h3>
            <p>
                <ul>
                <li>Route: Dharamshala - Shimla - Manali - Kasoli - Kullu - Rohtang Pass </li><br>
                <li>Duration: 7 Days, 6 Night </li><br>
                <li>Start Point: Dharamshala </li><br>
                <li>End Point: Dharamshala </li><br>
                </ul>
            </p>
            ...
            <p>
                <ul>
              <li>By Air: Kangra Airport Airport in Dharamshala is a feasible option for traveling to various places in Himachal Pradesh as it serves domestic airport. </li><br>
              <li>By Rail: Another alternative is the Dharamshala Railway Station, through which most trains arrive and depart from Dharamshala to all around India. </li><br>
              <li>By Road: Dharamshala is well connected by bus to major cities like Kasol, Manali, Shimla, Kullu, Dharamkot. </li><br>
            </ul>
            </p>
             </section>
          </div>
      ...
      <section id="about" class="about">
        ...
        <div class="team-members">
          <div class="team-member">
            ...
            <img src="projectimg/shimla2.jpg" alt="Nature" width="270" height="250">
            <img src="projectimg/manali1.jpg" alt="Nature" width="270" height="250">
            <img src="projectimg/kasol2.jpg" alt="Nature" width="270" height="250">
            <img src="projectimg/rohtangpass.jpg" alt="Nature" width="270" height="250">
            <img src="projectimg/kasol1.jpg" alt="Nature" width="270" height="250">
            <img src="projectimg/kufri1.jpg" alt="Nature" width="270" height="250">
            <img src="projectimg/manali2.jpg" alt="Nature" width="270" height="250">
            <img src="projectimg/shimla1.jpg" alt="Nature" width="270" height="250">
            </marquee>
          </div>
        </div>
      </section>
