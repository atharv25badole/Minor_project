    ...
    <main>
      <section class="hero">
        ...
        <div class="hero-content">
          <h1>Welcome to Maharastra Tour</h1>
          <p>The Gateway of India....</p>
      ...
      <section id="hotels" class="destinations">
        ...
        <div class="destination-grid" style="font-family:serif;font-size:20px">
          <div class="destination-item">
            ...
            <p>
              Embark on a magical adventure through Travel's World, starting from Mumbai 
              and journeying through Lonavala, Ellora and Ajanta, Shirdi, Nasik, Aurangabad
              before returning to Mumbai. It's a chance to have a variety of breakfast 
              and fast-food items in Maharastra, and immerse yourself in the serene 
              charm of Maharastra.
            </p>
            <h3><b><u>Quick Info:</b></u></h3>
            <p>
                <ul>
                <li>Route: Mumbai - Lonavala - Ellora and Ajanta - Shirdi - Nasik - Aurangabad  </li><br>
                <li>Duration: 7 Days, 6 Night </li><br>
                <li>Start Point: Mumbai </li><br>
                <li>End Point: Mumbai </li><br>
                </ul>
            </p>
            ...
            <p>
                <ul>
              <li>By Air: Chhatrapati Shivaji Maharaj Airport in Mumbai is a feasible option for traveling to various places in Maharastra as it serves both domestic and international flights. </li><br>
              <li>By Rail: Another alternative is the Mumbai central Station, through which most trains arrive and depart from Mumbai to all around India. </li><br>
              <li>By Road: Mumbai is well connected by bus to major cities like Nasik, Aurangabad, Pune, Mahabaleshwar, Khandalal. </li><br>
            </ul>
            </p>
            </section>
          </div>
      ...
      <section id="about" class="about">
        ...
        <div class="team-members">
          <div class="team-member">
            ...
            <img src="projectimg/lonavala1.jpg" alt="Nature" width="270" height="250">
            <img src="projectimg/shirdi.jpg" alt="Nature" width="270" height="250">
            <img src="projectimg/lonavala2.jpg" alt="Nature" width="270" height="250">
            <img src="projectimg/nasik1.jpg" alt="Nature" width="270" height="250">
            <img src="projectimg/shirdi1.jpg" alt="Nature" width="270" height="250">
            <img src="projectimg/ellora1.jpg" alt="Nature" width="270" height="250">
            <img src="projectimg/nasik2.jpg" alt="Nature" width="270" height="250">
            <img src="projectimg/ellora2.jpg" alt="Nature" width="270" height="250">
            <img src="projectimg/aurangabad2.jpg" alt="Nature" width="270" height="250">
            </marquee>
          </div>
        </div>
      </section>
