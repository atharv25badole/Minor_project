    ...
    <main>
      <section class="hero">
        ...
        <div class="hero-content">
          <h1>Welcome to Uttarakhand Tour</h1>
          <p>The Crown of Himalaya....</p>
      ...
      <section id="hotels" class="destinations">
        ...
        <div class="destination-grid" style="font-family:serif;font-size:20px">
          <div class="destination-item">
            ...
            <p>
              Embark on a magical adventure through Travel's World, starting from Dehradun
              and journeying through Rishikesh, Nainital, Masoori, Valley of Flowers and Haridwar.
              before returning to Dehradun. It's a chance to have a variety of Mountain cuisine in Uttarakhand, and immerse yourself in the serene 
              charm of Uttarakhand.
            </p>
            <h3><b><u>Quick Info:</b></u></h3>
            <p>
                <ul>
                <li>Route: Dehradun - Rishikesh - Nainital - Masoori - Valley of Flowers - Haridwar  </li><br>
                <li>Duration: 7 Days, 6 Night </li><br>
                <li>Start Point: Dehradhun </li><br>
                <li>End Point: Dehradhun </li><br>
                </ul>
            </p>
            ...
            <p>
                <ul>
              <li>By Air: Jolly Grant Airport - Dehradun Airport in Dehradun is a feasible option for traveling to various places in Uttarakhand as it serves both domestic and international flights. </li><br>
              <li>By Rail: Another alternative is the Dehradun Railway Station, through which most trains arrive and depart from Dehradun to all around India. </li><br>
              <li>By Road: Dehradun is well connected by bus to major cities like Haridwar, Rishikesh, Nainital, Roorkee and Masoori. </li><br>
            </ul>
            </p>
            </section>
          </div>
      ...
      <section id="about" class="about">
        ...
        <div class="team-members">
          <div class="team-member">
            ...
            <img src="projectimg/HARIDWAR1.jpg" alt="Nature" width="270" height="250">
            <img src="projectimg/nainital 1.jpg" alt="Nature" width="270" height="250">
            <img src="projectimg/valeyFlower1.jpg" alt="Nature" width="270" height="250">
            <img src="projectimg/HARIDWAR2.jpg" alt="Nature" width="270" height="250">
            <img src="projectimg/masuri2.jpg" alt="Nature" width="270" height="250">
            <img src="projectimg/nainital 2.jpg" alt="Nature" width="270" height="250">
            <img src="projectimg/Valley_of_Flower2.jpeg" alt="Nature" width="270" height="250">
            <img src="projectimg/rishikesh2.jpg" alt="Nature" width="270" height="250">
            <img src="projectimg/rishikesh3.jpg" alt="Nature" width="270" height="250">
            </marquee>
          </div>
        </div>
      </section>
